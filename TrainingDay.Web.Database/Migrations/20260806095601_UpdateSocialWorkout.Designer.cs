...
namespace TrainingDay.Web.Database.Migrations
{
    ...
    [Migration("20260806095601_UpdateSocialWorkout")]
    partial class UpdateSocialWorkout
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingDay.Web.Entities.MobileItems.SocialWorkoutExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SocialWorkoutId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SocialWorkoutId");

                    b.ToTable("SocialWorkoutExercises");
                });

            modelBuilder.Entity("TrainingDay.Web.Entities.MobileItems.SocialWorkoutLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SocialWorkoutId", "UserId")
                        .IsUnique();

                    b.ToTable("SocialWorkoutLikes");
                });
            ...
            modelBuilder.Entity("TrainingDay.Web.Entities.MobileUser", b =>
                {
                    ...
                    b.Property<bool>("ShareCompletedWorkouts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("TrainingDay.Web.Entities.MobileUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrainingDay.Web.Entities.MobileItems.SocialWorkoutExercise", b =>
                {
                    b.HasOne("TrainingDay.Web.Entities.MobileItems.SocialWorkout", "SocialWorkout")
                        .WithMany("Exercises")
                        .HasForeignKey("SocialWorkoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SocialWorkout");
                });
